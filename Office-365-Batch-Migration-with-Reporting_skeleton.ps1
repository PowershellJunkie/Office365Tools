...
$365cred = Get-Credential "yourO365mail@yourdomain.com" -Message "Enter O365 Creds"
$exadmin = Get-Credential "yourdomain\yourexchangeadminName" -Message "Enter Domain Admin Creds"
